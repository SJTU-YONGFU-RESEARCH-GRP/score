...
module AHBlite_sys_0(
		...
		input wire [31: 0] SRAMRDATA_S3,
		output wire [3: 0] SRAMWEN_S3,
		output wire [31: 0] SRAMWDATA_S3,
		output wire [0: 0] SRAMCS0_S3,
		output wire [0: 0] SRAMCS1_S3,
		output wire [0: 0] SRAMCS2_S3,
		output wire [0: 0] SRAMCS3_S3,
		output wire [14: 0] SRAMADDR_S3,
		output IRQ_SS0_S0,
        ...
        AHBSRAM S3 ( 
			...
			.HRDATA(HRDATA_S3),
			.HREADYOUT(HREADY_S3),
			.SRAMRDATA(SRAMRDATA_S3),
			.SRAMWEN(SRAMWEN_S3),
			.SRAMWDATA(SRAMWDATA_S3),
			.SRAMCS0(SRAMCS0_S3),
			.SRAMCS1(SRAMCS1_S3),
			.SRAMCS2(SRAMCS2_S3),
			.SRAMCS3(SRAMCS3_S3),
			.SRAMADDR(SRAMADDR_S3)
            );
