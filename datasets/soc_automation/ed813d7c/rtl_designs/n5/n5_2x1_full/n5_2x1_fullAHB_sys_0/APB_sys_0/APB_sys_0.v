...
module apb_sys_0(
	...
	output IRQ_S0,
	input wire [0: 0] scl_i_S1,
	output wire [0: 0] scl_o_S1,
	output wire [0: 0] scl_oen_o_S1,
	input wire [0: 0] sda_i_S1,
	output wire [0: 0] sda_o_S1,
	output wire [0: 0] sda_oen_o_S1,
	input wire [0: 0] MSI_S2,
	output wire [0: 0] MSO_S2,
	output wire [0: 0] SSn_S2,
	output wire [0: 0] SCLK_S2,
	output wire [0: 0] pwm_S3
    );
   ...
   wire [31: 0] TMR_S0;
                   ...
                   wire [0: 0] TMREN_S0;
                   wire [31: 0] PRE_S3;
                   wire [31: 0] TMRCMP1_S3;
                   wire [31: 0] TMRCMP2_S3;
                   wire [0: 0] TMREN_S3;
    ...
    APB_TIMER32 S_0 (
        ...
        .PCLK(PCLK),
			...
			.PENABLE(PENABLE),
                ...
                .scl_i(scl_i_S1),   
                .scl_o(scl_o_S1),   
                .scl_oen_o(scl_oen_o_S1),   
                .sda_i(sda_i_S1),   
                .sda_o(sda_o_S1),   
                .sda_oen_o(sda_oen_o_S1)
        );
