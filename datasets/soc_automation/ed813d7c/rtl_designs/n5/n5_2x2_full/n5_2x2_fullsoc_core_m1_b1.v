...
module soc_core_m1_b1(
	...
	input wire [3: 0] fdi_Sys0_S3,
	output wire [3: 0] fdo_Sys0_S3,
	output wire [3: 0] fdoe_Sys0_S3,
	output wire [0: 0] fsclk_Sys0_S3,
	output wire [0: 0] fcen_Sys0_S3,
...
wire [0: 0] M2_IRQ;
	...
	AHBlite_sys_0 ahb_sys_0_uut(
		...
		.fdi_S3(fdi_Sys0_S3),
		.fdo_S3(fdo_Sys0_S3),
		.fdoe_S3(fdoe_Sys0_S3),
		.fsclk_S3(fsclk_Sys0_S3),
		.fcen_S3(fcen_Sys0_S3),
		.db_reg(db_reg_Sys0),
