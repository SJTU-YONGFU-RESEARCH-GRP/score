...
VL_INLINE_OPT void Vara_tb_verilator___024root___nba_comb__TOP__594(Vara_tb_verilator___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vara_tb_verilator__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vara_tb_verilator___024root___nba_comb__TOP__594\n"); );
    // Init
...
VL_INLINE_OPT void Vara_tb_verilator___024root___nba_comb__TOP__595(Vara_tb_verilator___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vara_tb_verilator__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vara_tb_verilator___024root___nba_comb__TOP__595\n"); );
    // Init
