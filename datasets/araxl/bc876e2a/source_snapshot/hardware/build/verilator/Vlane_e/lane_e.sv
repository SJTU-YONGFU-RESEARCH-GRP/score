...
module lane_e (
        ...
        , input logic [2:0]  num_clusters_i
        , output logic vxsat_flag_o
        , input logic [1:0]  alu_vxrm_i
        , output logic [4:0]  fflags_ex_o
        , output logic fflags_ex_valid_o
        , input logic [280:0]  pe_req_i
        ...
        , output logic [63:0]  sldu_operand_o
        , output logic sldu_addrgen_operand_valid_o
        , output logic sldu_red_operand_valid_o
        , output logic sldu_addrgen_operand_target_fu_o
        , input logic sldu_operand_ready_i
        , input logic [1:0]  sldu_issue_mux_sel_i
        , input logic [1:0]  sldu_commit_mux_sel_i
    ...
    logic [63:0]  sldu_operand_o_combo__V;
    logic sldu_addrgen_operand_valid_o_combo__V;
    logic sldu_red_operand_valid_o_combo__V;
    ...
    logic [63:0]  sldu_operand_o_seq__V;
    logic sldu_addrgen_operand_valid_o_seq__V;
    logic sldu_red_operand_valid_o_seq__V;
    ...
    logic [63:0]  sldu_operand_o_tmp__V;
    logic sldu_addrgen_operand_valid_o_tmp__V;
    logic sldu_red_operand_valid_o_tmp__V;
    ...
    // library agree
    localparam int protectlib_hash__V = 32'd1607351943;
    ...
    always @(posedge clk_i or negedge clk_i, posedge rst_ni or negedge rst_ni) begin
        ...
        last_seq_seqnum__V <= lane_e_protectlib_seq_update(
            ...
            , sldu_operand_o_tmp__V
            , sldu_addrgen_operand_valid_o_tmp__V
            , sldu_red_operand_valid_o_tmp__V
        ...
        sldu_operand_o_seq__V <= sldu_operand_o_tmp__V;
        sldu_addrgen_operand_valid_o_seq__V <= sldu_addrgen_operand_valid_o_tmp__V;
        sldu_red_operand_valid_o_seq__V <= sldu_red_operand_valid_o_tmp__V;
    ...
    always @* begin
        if (last_seq_seqnum__V > last_combo_seqnum__V) begin
            ...
            sldu_operand_o = sldu_operand_o_seq__V;
            sldu_addrgen_operand_valid_o = sldu_addrgen_operand_valid_o_seq__V;
            sldu_red_operand_valid_o = sldu_red_operand_valid_o_seq__V;
            ...
            sldu_operand_o = sldu_operand_o_combo__V;
            sldu_addrgen_operand_valid_o = sldu_addrgen_operand_valid_o_combo__V;
            sldu_red_operand_valid_o = sldu_red_operand_valid_o_combo__V;
