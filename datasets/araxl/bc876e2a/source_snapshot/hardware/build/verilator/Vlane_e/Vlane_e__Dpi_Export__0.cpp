...
void Vlane_e::simutil_memload(const char* file) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vlane_e___024root::simutil_memload\n"); );
    // Init
    ...
    Vlane_e__Vcb_simutil_memload_t __Vcb = (Vlane_e__Vcb_simutil_memload_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    file__Vcvt = file;
    (*__Vcb)((Vlane_e__Syms*)(__Vscopep->symsp()), file__Vcvt);
}

int Vlane_e::simutil_set_mem(int index, const svBitVecVal* val) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vlane_e___024root::simutil_set_mem\n"); );
    // Init
    IData/*31:0*/ index__Vcvt;
    index__Vcvt = 0;
    VlWide<16>/*511:0*/ val__Vcvt;
    VL_ZERO_W(512, val__Vcvt);
    ...
    const VerilatedScope* __Vscopep = Verilated::dpiScope();
    Vlane_e__Vcb_simutil_set_mem_t __Vcb = (Vlane_e__Vcb_simutil_set_mem_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    index__Vcvt = index;
    VL_SET_W_SVBV(512,val__Vcvt,val + 0);
(*__Vcb)((Vlane_e__Syms*)(__Vscopep->symsp()), index__Vcvt, val__Vcvt, simutil_set_mem__Vfuncrtn__Vcvt);
...
int Vlane_e::simutil_get_mem(int index, svBitVecVal* val) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vlane_e___024root::simutil_get_mem\n"); );
    // Init
    IData/*31:0*/ index__Vcvt;
    index__Vcvt = 0;
    VlWide<16>/*511:0*/ val__Vcvt;
    ...
    const VerilatedScope* __Vscopep = Verilated::dpiScope();
    Vlane_e__Vcb_simutil_get_mem_t __Vcb = (Vlane_e__Vcb_simutil_get_mem_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    index__Vcvt = index;
    (*__Vcb)((Vlane_e__Syms*)(__Vscopep->symsp()), index__Vcvt, val__Vcvt, simutil_get_mem__Vfuncrtn__Vcvt);
