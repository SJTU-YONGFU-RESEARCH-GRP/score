...
extern "C" {
    ...
    void lane_e_protectlib_check_hash(int protectlib_hash__V) {
        const int expected_hash__V = 1607351943U;
    ...
    void* lane_e_protectlib_create(const char* scopep__V) {
        Vlane_e_container* const handlep__V = new Vlane_e_container{scopep__V};
        return handlep__V;
    }
    ...
    long long lane_e_protectlib_combo_update(
        ...
        , const svLogicVecVal* cluster_id_i
        , const svLogicVecVal* num_clusters_i
        ...
        , svLogicVecVal* sldu_operand_o
        , svLogic* sldu_addrgen_operand_valid_o
        , svLogic* sldu_red_operand_valid_o
        , svLogic* sldu_addrgen_operand_target_fu_o
        , svLogic sldu_operand_ready_i
        , const svLogicVecVal* sldu_issue_mux_sel_i
        , const svLogicVecVal* sldu_commit_mux_sel_i
        ...
        , svLogic sldu_red_pending_i
        , svLogic sldu_red_completed_i
    ...
    {
        Vlane_e_container* const handlep__V = static_cast<Vlane_e_container*>(vhandlep__V);
        handlep__V->scan_enable_i = scan_enable_i;
        handlep__V->scan_data_i = scan_data_i;
        handlep__V->lane_id_i = VL_SET_I_SVLV(lane_id_i);
        handlep__V->cluster_id_i = VL_SET_I_SVLV(cluster_id_i);
        handlep__V->num_clusters_i = VL_SET_I_SVLV(num_clusters_i);
        handlep__V->alu_vxrm_i = VL_SET_I_SVLV(alu_vxrm_i);
        VL_SET_W_SVLV(281, handlep__V->pe_req_i, pe_req_i + 0);
        ...
        handlep__V->sldu_issue_mux_sel_i = VL_SET_I_SVLV(sldu_issue_mux_sel_i);
        handlep__V->sldu_commit_mux_sel_i = VL_SET_I_SVLV(sldu_commit_mux_sel_i);
        ...
        handlep__V->sldu_red_pending_i = sldu_red_pending_i;
        handlep__V->sldu_red_completed_i = sldu_red_completed_i;
        ...
        for (size_t sldu_operand_o__Vidx = 0; sldu_operand_o__Vidx < 1; ++sldu_operand_o__Vidx) VL_SET_SVLV_Q(64, sldu_operand_o + 2 * sldu_operand_o__Vidx, handlep__V->sldu_operand_o);
        ...
        for (size_t sldu_red_operand_valid_o__Vidx = 0; sldu_red_operand_valid_o__Vidx < 1; ++sldu_red_operand_valid_o__Vidx) *sldu_red_operand_valid_o = handlep__V->sldu_red_operand_valid_o;
