...
class Vlane_e__Syms;
class Vlane_e___024root;
class Vlane_e___024unit;
class Vlane_e_ara_pkg;


// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) Vlane_e VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    VL_OUT64(&sldu_operand_o,63,0);
    VL_OUT8(&sldu_addrgen_operand_valid_o,0,0);
    VL_OUT8(&sldu_red_operand_valid_o,0,0);
    VL_OUT8(&sldu_addrgen_operand_target_fu_o,0,0);
    VL_IN8(&sldu_operand_ready_i,0,0);
    VL_IN8(&sldu_issue_mux_sel_i,1,0);
    VL_IN8(&sldu_commit_mux_sel_i,1,0);
    ...
    VL_IN8(&sldu_red_pending_i,0,0);
    VL_IN8(&sldu_red_completed_i,0,0);
    ...
    Vlane_e___024unit* const __PVT____024unit;
    Vlane_e_ara_pkg* const __PVT__ara_pkg;

    // Root instance pointer to allow access to model internals,
    // including inlined /* verilator public_flat_* */ items.
    Vlane_e___024root* const rootp;
