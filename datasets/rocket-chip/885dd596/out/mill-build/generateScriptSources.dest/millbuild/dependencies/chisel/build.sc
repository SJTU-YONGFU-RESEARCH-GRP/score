...
class build extends _root_.mill.main.RootModule.Foreign(Some(_root_.mill.define.Segments.labels("foreign-modules", "dependencies", "chisel", "build"))) {

//MILL_ORIGINAL_FILE_PATH=/home/yongfu/proj/score/tools/rocket-chip/dependencies/chisel/build.sc
