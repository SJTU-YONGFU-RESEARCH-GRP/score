...
info() { echo -e "${BLUE}[install_snitch_cluster]${NC} $*"; }
ok() { echo -e "${GREEN}[install_snitch_cluster]${NC} $*"; }
warn() { echo -e "${YELLOW}[install_snitch_cluster]${NC} $*"; }
err() { echo -e "${RED}[install_snitch_cluster]${NC} $*" >&2; }
