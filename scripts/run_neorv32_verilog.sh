...
info() { echo -e "${BLUE}[run_neorv32_verilog]${NC} $*"; }
ok() { echo -e "${GREEN}[run_neorv32_verilog]${NC} $*"; }
warn() { echo -e "${YELLOW}[run_neorv32_verilog]${NC} $*"; }
err() { echo -e "${RED}[run_neorv32_verilog]${NC} $*" >&2; }
