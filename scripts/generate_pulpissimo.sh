...
info() { echo -e "${BLUE}[generate_pulpissimo]${NC} $*"; }
ok() { echo -e "${GREEN}[generate_pulpissimo]${NC} $*"; }
warn() { echo -e "${YELLOW}[generate_pulpissimo]${NC} $*"; }
err() { echo -e "${RED}[generate_pulpissimo]${NC} $*" >&2; }
