...
info() { echo -e "${BLUE}[generate_picobello]${NC} $*"; }
ok() { echo -e "${GREEN}[generate_picobello]${NC} $*"; }
warn() { echo -e "${YELLOW}[generate_picobello]${NC} $*"; }
err() { echo -e "${RED}[generate_picobello]${NC} $*" >&2; }
