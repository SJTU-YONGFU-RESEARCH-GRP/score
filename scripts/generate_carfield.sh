...
info() { echo -e "${BLUE}[generate_carfield]${NC} $*"; }
ok() { echo -e "${GREEN}[generate_carfield]${NC} $*"; }
warn() { echo -e "${YELLOW}[generate_carfield]${NC} $*"; }
err() { echo -e "${RED}[generate_carfield]${NC} $*" >&2; }
