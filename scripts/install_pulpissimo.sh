...
info() { echo -e "${BLUE}[install_pulpissimo]${NC} $*"; }
ok() { echo -e "${GREEN}[install_pulpissimo]${NC} $*"; }
warn() { echo -e "${YELLOW}[install_pulpissimo]${NC} $*"; }
err() { echo -e "${RED}[install_pulpissimo]${NC} $*" >&2; }
